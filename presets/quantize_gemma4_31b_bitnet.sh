...
$PYTHON quantize.py --preset gemma4_31b \
    --mode 1bit \
    --device cuda:0 \
    --output "$WORK_DIR/gemma-4-31b-bitnet"

# --- convert to GGUF ---
echo ""
echo "[5/5] converting to GGUF..."
$PYTHON quantize.py --gguf "$WORK_DIR/gemma-4-31b-bitnet" \
    --output "$WORK_DIR/gemma-4-31b-bitnet.gguf"
...
echo ""
echo "output:"
echo "  GGUF: $WORK_DIR/gemma-4-31b-bitnet.gguf"
echo ""
echo "use with llama.cpp:"
echo "  ./llama-server -m $WORK_DIR/gemma-4-31b-bitnet.gguf -c 4096"
